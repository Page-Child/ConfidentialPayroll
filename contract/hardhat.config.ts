...
// Support environment variables for deployment (Windows PowerShell: $env:MNEMONIC="...")
...
// Support custom Sepolia RPC URL (Windows PowerShell: $env:SEPOLIA_RPC_URL="...")
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    sepolia: {
      ...
      chainId: 11155111,
      // Use custom RPC URL if provided, otherwise fall back to Infura
